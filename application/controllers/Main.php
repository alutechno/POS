...
class Main extends CI_Controller {
	...
	function payment() {
		...
		$data = array('table_no' => $this->uri->segment(3), 'order_no' => $this->global_model->get_no_bill($this->uri->segment(3)));
	...
	function pesan() {
		...
		$data = array('order_no' => $tot, 'table_no' => $this->uri->segment(3), 'order_no' => $tot);
	...
	function inputpesan() {
		...
		$data = array('menu_id' => $this->uri->segment(3), 'amount' => $this->uri->segment(4), 'qty' => 1, 'tax' => ($this->uri->segment(4)) * (11 / 100), 'service' => ($this->uri->segment(4)) * (10 / 100), 'order_no' => $this->session->userdata('order_no'), 'menu_class_id' => $this->uri->segment(5), 'table_id' => $this->uri->segment(6), 'outlet_id' => $this->session->userdata('outlet'));
		...
		$data = array(
			'menu_id' => $this->uri->segment(3), 'amount' => $this->uri->segment(4), 'qty' => 1, 'tax' => $taxVal, 'service' => $serviceVal, 'order_no' => $this->session->userdata('order_no'), 'menu_class_id' => $this->uri->segment(5), 'table_id' => $this->uri->segment(6), 'outlet_id' => $outletId);
		//order_no
	...
	function inputpesan2() {
		...
		$data = array('order_id' => $this->session->userdata('no_bill'), 'outlet_menu_id' => $kode_menu, 'order_qty' => 1, 'price_amount' => $price, 'total_amount' => $price,);
	...
	function input_guest() {
		...
		$data = array('outlet_id' => $outlet_id, 'table_no' => $table_id, 'guest' => $guest, 'status_closed' => 0, 'order_no' => $nomor_bill);
	...
	function include_room() {
		...
		$data = array('total' => $amount, 'tax' => $tax, 'folio_id' => $room, 'status_closed' => 1);
	...
	function openmenu() {
		...
		$data = array('menu_id' => 'My title', 'qty' => 'My Name', 'order_no' => 'My date');
