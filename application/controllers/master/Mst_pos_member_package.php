<?php
	...
	class Mst_pos_member_package extends CI_Controller {
		...
		public function read($id) {
			...
			if ($row) {
				$data = array('id' => $row->id, 'code' => $row->code,
					'title' => 'Pos Member Package', 'name' => $row->name,
		...
		public function create() {
			$data = array('button' => 'Create',
				'action' => base_url('master/mst_pos_member_package/create_action'),
				'title' => 'Pos Member Package', 'id' => set_value('id'),
		...
		public function update($id) {
			...
			if ($row) {
				$data = array('button' => 'Update',
					'action' => base_url('mst_pos_member_package/update_action'),
