...
class Mst_pos_tables extends CI_Controller {
	...
	public function create() {
		$data = array('button' => 'Create', 'title' => 'Master Table', 'action' => base_url('master/mst_pos_tables/create_action'), 'id' => set_value('id'), 'outlet_id' => set_value('outlet_id'), 'table_no' => set_value('table_no'), 'cover' => set_value('cover'), 'section' => set_value('section'), 'remark' => set_value('remark'), 'status' => set_value('status'),);
	...
	public function create_action() {
		...
		if ($this->form_validation->run() == FALSE) {
			...
			$data = array('outlet_id' => $this->input->post('outlet_id', TRUE), 'table_no' => $this->input->post('table_no', TRUE), 'cover' => $this->input->post('cover', TRUE), 'section' => $this->input->post('section', TRUE), 'remark' => $this->input->post('remark', TRUE), 'status' => $this->input->post('status', TRUE),);
	...
	public function update($id) {
		...
		if ($row) {
			$data = array('button' => 'Update', 'title' => 'tables', 'action' => base_url('master/mst_pos_tables/update_action'), 'id' => set_value('id', $row->id), 'outlet_id' => set_value('outlet_id', $row->outlet_id), 'table_no' => set_value('table_no', $row->table_no), 'cover' => set_value('cover', $row->cover), 'section' => set_value('section', $row->section), 'remark' => set_value('remark', $row->remark), 'status' => set_value('status', $row->status),);
			form('master/mst_pos_tables/mst_pos_tables_form', $data);
		} else {
