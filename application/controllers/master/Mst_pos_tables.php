<?php
	...
	class Mst_pos_tables extends CI_Controller {
		...
		public function create() {
			$data = array('button' => 'Create', 'title' => 'Master Table',
				'action' => base_url('master/mst_pos_tables/create_action'),
				'id' => set_value('id'), 'outlet_id' => set_value('outlet_id'),
				'table_no' => set_value('table_no'), 'cover' => set_value('cover'),
				'section' => set_value('section'), 'remark' => set_value('remark'),
		...
		public function update($id) {
			...
			if ($row) {
				$data = array('button' => 'Update', 'title' => 'tables',
