<?php
	...
	class Mst_pos_cost_center extends CI_Controller {
		...
		public function read($id) {
			...
			if ($row) {
				$data = array('id' => $row->id, 'code' => $row->code, 'name' => $row->name,
					...
					'status' => $row->status, 'created_date' => $row->created_date,
		...
		public function create() {
			$data = array('button' => 'Create', 'title' => 'Cost Center',
				'action' => site_url('mst_pos_cost_center/create_action'), 'id' => set_value('id'),
		...
		public function update($id) {
			...
			if ($row) {
				$data = array('button' => 'Update',
					'action' => site_url('mst_pos_cost_center/update_action'),
