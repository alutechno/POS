<?php
	...
	class Mst_pos_discount extends CI_Controller {
		...
		public function read($id) {
			...
			if ($row) {
				$data = array('id' => $row->id, 'code' => $row->code, 'title' => 'Diskon',
					'name' => $row->name, 'description' => $row->description,
					'status' => $row->status, 'food' => $row->food, 'beverage' => $row->beverage,
					'others' => $row->others, 'created_date' => $row->created_date,
		...
		public function create() {
			$data = array('button' => 'Create', 'title' => 'Diskon',
				...
				'food' => set_value('food'), 'beverage' => set_value('beverage'),
				'others' => set_value('others'), 'created_date' => set_value('created_date'),
