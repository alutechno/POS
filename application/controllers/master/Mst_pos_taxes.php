<?php
	...
	class Mst_pos_taxes extends CI_Controller {
		...
		public function read($id) {
			...
			if ($row) {
				$data = array('id' => $row->id, 'code' => $row->code, 'name' => $row->name,
					'description' => $row->description, 'tax_percent' => $row->tax_percent,
					'status' => $row->status,
				);
		...
		public function create() {
			$data = array('button' => 'Create', 'action' => base_url('mst_pos_taxes/create_action'),
				'id' => set_value('id'), 'title' => 'Tax', 'code' => set_value('code'),
				'name' => set_value('name'), 'description' => set_value('description'),
				'tax_percent' => set_value('tax_percent'), 'status' => set_value('status'),
			);
		...
		public function update($id) {
			$row = $this->Mst_pos_taxes_model->get_by_id($id);
			if ($row) {
				$data = array('button' => 'Update', 'title' => 'Tax',
