<?php
	...
	class Inv_outlet_menus extends CI_Controller {
		...
		public function create() {
			$data = array('button' => 'Create', 'title' => 'Menu List',
				...
				'outlet_id' => set_value('outlet_id'), 'status' => set_value('status'),
				'menu_class_id' => set_value('menu_class_id'),
				'menu_group_id' => set_value('menu_group_id'),
				'menu_price' => set_value('menu_price'), 'unit_cost' => set_value('unit_cost'),
				'image' => set_value('image'), 'product_id' => set_value('product_id'),
				'recipe_id' => set_value('recipe_id'), 'recipe_qty' => set_value('recipe_qty'),
			...
			if ($this->form_validation->run() == false) {
				...
				if ($_FILES['file']['name'] <> "") {
					...
					$data = array('code' => $this->input->post('code', true),
						'name' => $this->input->post('name', true), 'image' => $file_name,
		...
		public function update($id) {
			...
			if ($row) {
				// echo $row->image;exit;
				$data = array('button' => 'Update', 'title' => 'Menu List',
