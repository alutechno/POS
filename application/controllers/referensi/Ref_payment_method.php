<?php
	...
	class Ref_payment_method extends CI_Controller {
		...
		public function read($id) {
			...
			if ($row) {
				$data = array('id' => $row->id, 'code' => $row->code, 'title' => 'Payment Method',
					'name' => $row->name, 'description' => $row->description,
					'status' => $row->status, 'credit_limit' => $row->credit_limit,
					'is_credit_card' => $row->is_credit_card, 'account_id' => $row->account_id,
		...
		public function create() {
			$data = array('button' => 'Create',
				...
				'id' => set_value('id'), 'title' => 'Payment Method', 'code' => set_value('code'),
				'name' => set_value('name'), 'description' => set_value('description'),
				'status' => set_value('status'), 'credit_limit' => set_value('credit_limit'),
		...
		public function update($id) {
			$row = $this->Ref_payment_method_model->get_by_id($id);
			if ($row) {
				$data = array('button' => 'Update', 'title' => 'Payment Method',
