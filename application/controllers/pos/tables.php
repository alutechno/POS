<?php
	...
	class Tables extends CI_Controller {
		...
		function pesan() {
			...
			$data = array('order_no' => $tot, 'table_no' => $this->uri->segment(4),
				'order_no' => $tot);
		...
		function inputpesan() {
			...
			$data = array('menu_id' => $this->uri->segment(5), 'amount' => 30000, 'qty' => 1,
				'tax' => 30000 / 10, 'order_no' => $this->session->order_no);
		...
		public function create_pdf() {
			...
			$pdf->SetHeaderData(PDF_HEADER_LOGO, PDF_HEADER_LOGO_WIDTH, PDF_HEADER_TITLE . ' 001',
								PDF_HEADER_STRING, array(0,
									64, 255), array(0, 64, 128));
			...
			$pdf->setTextShadow(array('enabled' => true, 'depth_w' => 0.2, 'depth_h' => 0.2,
									'color' => array(196, 196, 196), 'opacity' => 1,
									'blend_mode' => 'Normal'));
