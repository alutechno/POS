...
class Pos_outlet_tables extends CI_Controller {
	...
	public function create() {
		$data = array('button' => 'Create', 'action' => base_url('setting/pos_outlet_tables/create_action'), 'title' => 'Outlet Tables', 'id' => set_value('id'), 'name' => set_value('name'), 'zone_id' => set_value('zone_id'),);
	...
	public function create_action() {
		...
		if ($this->form_validation->run() == FALSE) {
			...
			$data = array('name' => $this->input->post('name', TRUE), 'zone_id' => $this->input->post('zone_id', TRUE),);
	...
	public function update($id) {
		...
		if ($row) {
			$data = array('button' => 'Update', 'title' => 'Outlet Tables', 'action' => base_url('setting/pos_outlet_tables/update_action'), 'id' => set_value('id', $row->id), 'name' => set_value('name', $row->name), 'zone_id' => set_value('zone_id', $row->zone_id),);
