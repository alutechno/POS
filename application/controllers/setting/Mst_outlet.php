...
class Mst_outlet extends CI_Controller
{
    ...
    public function read($id) 
    {
		...
		'num_of_employee' => $row->num_of_employee,
    ...
    public function create() 
    {
        $data = array(
            'button' => 'Create',
            'title'=>'Outlet',
            'action' => base_url('setting/mst_outlet/create_action'),
	    'id' => set_value('id'),
	    'code' => set_value('code'),
	    'name' => set_value('name'),
	    'address' => set_value('address'),
	    'bill_footer' => set_value('bill_footer'),
	    'status' => set_value('status'),
	    'outlet_type_id' => set_value('outlet_type_id'),
	    'cost_center_id' => set_value('cost_center_id'),
	    'delivery_bill_footer' => set_value('delivery_bill_footer'),
	    'no_of_seats' => set_value('no_of_seats'),
	    'm2' => set_value('m2'),
    ...
    public function create_action() 
    {
		...
		'printed_bill_image_path' => $this->input->post('printed_bill_image_path',TRUE),
		'small_printed_bill_image_uri' => $this->input->post('small_printed_bill_image_uri',TRUE),
		'small_printed_bill_image_path' => $this->input->post('small_printed_bill_image_path',TRUE),
    ...
    public function update($id) 
    {
        ...
        if ($row) {
            $data = array(
                'button' => 'Update',
                'action' => base_url('setting/mst_outlet/update_action'),
                'title'=>'Outlet',
		...
		'delivery_bill_footer' => set_value('delivery_bill_footer', $row->delivery_bill_footer),
		...
		'is_allow_cancel_tax' => set_value('is_allow_cancel_tax', $row->is_allow_cancel_tax),
		'fo_gl_journal_code' => set_value('fo_gl_journal_code', $row->fo_gl_journal_code),
		'bill_image_uri' => set_value('bill_image_uri', $row->bill_image_uri),
		'bill_image_path' => set_value('bill_image_path', $row->bill_image_path),
		'small_bill_image_uri' => set_value('small_bill_image_uri', $row->small_bill_image_uri),
		'small_bill_image_path' => set_value('small_bill_image_path', $row->small_bill_image_path),
		'printed_bill_image_uri' => set_value('printed_bill_image_uri', $row->printed_bill_image_uri),
		'printed_bill_image_path' => set_value('printed_bill_image_path', $row->printed_bill_image_path),
		'small_printed_bill_image_uri' => set_value('small_printed_bill_image_uri', $row->small_printed_bill_image_uri),
		'small_printed_bill_image_path' => set_value('small_printed_bill_image_path', $row->small_printed_bill_image_path),
