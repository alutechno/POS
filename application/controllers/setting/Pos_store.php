<?php
	...
	class Pos_store extends CI_Controller {
		...
		public function create() {
			$data = array('button' => 'Create', 'title' => 'Store',
				'action' => base_url('setting/pos_store/create_action'), 'id' => set_value('id'),
				'store_name' => set_value('store_name'), 'email' => set_value('email'),
		...
		public function create_action() {
			...
			if ($this->form_validation->run() == false) {
				...
				$data = array('store_name' => $this->input->post('store_name', true),
		...
		public function update($id) {
			...
			if ($row) {
				$data = array('button' => 'Update', 'title' => 'Store',
					'action' => base_url('setting/pos_store/update_action'),
