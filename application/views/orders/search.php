		...
		<div class="box box-solid">
			...
			<div class="box-body text-center">
				...
				<iframe width="360" frameBorder="0" height="415"
						src="<?= base_url() ?>main/payment_total/<?= $this->uri->segment(3) ?>"
						allowfullscreen></iframe>
				<!-- end -->
				<a class="btn btn-app bg-red" href='<?= base_url() ?>main/cancel_order'
				   onclick="javasciprt: return confirm('Are you Sure Cancel This Order ?')">
				...
				<a class="btn btn-app bg-green">
					<i class="fa fa-money"
					   onclick="print_payment(<?= $this->session->order_no; ?>)"></i> Payment
				</a>
