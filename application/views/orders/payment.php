...
<div class="form-group">
      ...
      <div class="modal-footer">
        ...
        <button type="submit" class="btn btn-primary" onclick="print_payment(<?=$this->session->order_no;?>)">Submit</button>
      </div>
      </form>
    </div>
  </div>
...
<!-- modal -->
<div class="modal fade" id="myModalOpenMenu" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
...
<form id="subscribe-email-form" action="<?php echo base_url()?>main/openmenu" method="post">
    ...
    ?>
      <tr>
        <td><input type="text" class="form-control" id="menu_<?php echo $i?>" name="menu_<?php echo $i?>"></td>
        <td><input type="text" class="form-control" id="qty_<?php echo $i?>" name="qty_<?php echo $i?>"></td>
        <td><input type="text" class="form-control" id="price_<?php echo $i?>" name="price_<?php echo $i?>"></td>
      </tr>
    <?php
    }
    ?>
...
{
                      ?>
                          <option value="<?php echo $row->folio_id?>">[<?php echo $row->folio_id?>]&nbsp;<?php echo $row->guest_name?></option>
                      <?php
}
                      ?>
                        </select>
...
<!-- START CUSTOM TABS -->
                          ...
                          <div class="col-md-8">
                            ...
                            <div class="nav-tabs-custom">
                               ...
                               <table>
                                  ...
                                  <th>:</th>
                                  <th>
                                    <?php echo $this->global_model->get_no_bill($this->uri->segment(3))?>/<?php echo $this->uri->segment(3)?>
                                  </th>
                                  <th>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</th>
                                  <th>Meal Time</th><th>:</th><th><?php echo $this->global_model->get_meal_time_name()?></th>
                                  </tr>
                                  <tr><th colspan="3">&nbsp;</th></tr>
                                </table>
 <!-- Main content -->
 <form action=" <?php echo base_url()?>main/reload_pesan" name="myform" id="myform" method="post">
 ...
 <div class="form-group row">
  <div class="col-xs-3">
   ...
   <select class="form-control" name="select_menu" id="select_menu" onchange="load()" >
          <?php
          ...
          {
          ?>
              <option value="<?php echo $row->id?>" <?php echo $row->id==$this->uri->segment(4)?'selected':'';?>><?php echo $row->name?></option>
        <?php
          }
        ?>
          </select>
                            ...
                            <div class="box box-solid">
                                <div class="box-header">
                                  ...
                                  <!-- <a class="btn btn-app" href=' <?php echo base_url('main')?>'>
                                    ...
                                    <a class="btn btn-app ">
                                        <i class="fa fa-money" onclick="print_payment('<?php echo $this->session->order_no;?>')"></i> Cash
                                    </a>
