	    ...
	    <div class="form-group">
            ...
            <input type="text" class="form-control" name="short_name" id="short_name" placeholder="Short Name" value="<?php echo $short_name; ?>" />
             ...
             <div class="form-group">
                                            ...
                                            <input type="file" id="file" name="file"><img src="<?=base_url()?>menu/<?=$image?>" width='180' height='120'> 
            </div>
        ...
        <div class="form-group">
            ...
            {
            ?>
                <option value='<?php echo $row->id?>' <?php echo $row->id== $outlet_id?'selected':'';?>><?php echo $row->name?></option>
             <?php
            }
             ?>
	   ...
	   <!-- <div class="form-group">
	    ...
	    <div class="form-group">
            ...
            <input type="text" class="form-control" name="menu_class_id" id="menu_class_id" placeholder="Menu Class Id" value="<?php echo $menu_class_id; ?>" />
        </div>
	    <!--<div class="form-group">
         ...
         <div class="form-group">
            ...
            {
            ?>
                <option value='<?php echo $row->id?>' <?php echo $row->id== $menu_group_id?'selected':'';?>><?php echo $row->name?></option>
             <?php
            }
             ?>
	    ...
	    <div class="form-group">
            ...
            <input type="text" class="form-control" name="menu_price" id="menu_price" placeholder="Menu Price" value="<?php echo $menu_price; ?>" />
        </div>
	    <div class="form-group">
            <label for="decimal">Unit Cost <?php echo form_error('unit_cost') ?></label>
            <input type="text" class="form-control" name="unit_cost" id="unit_cost" placeholder="Unit Cost" value="<?php echo $unit_cost; ?>" />
        </div>
         ...
         <div class="form-group">
            ...
            {
            ?>
                <option value='<?php echo $row->id?>' <?php echo $row->id== $product_id?'selected':'';?>><?php echo $row->name?></option>
             <?php
            }
             ?>
	  ...
	  <!--  <div class="form-group">
            ...
            {
            ?>
                <option value='<?php echo $row->id?>' <?php echo $row->id== $recipe_id?'selected':'';?>><?php echo $row->name?></option>
             <?php
            }
             ?>
	    ...
	    <div class="form-group">
            ...
            <input type="text" class="form-control" name="recipe_qty" id="recipe_qty" placeholder="Recipe Qty" value="<?php echo $recipe_qty; ?>" />
         </div>
      ...
      <!--<div class="form-group">
        ...
        <div class="form-group">
             ...
             <select class="form-control" name="is_export_cost" id="is_export_cost">
                <option value='Y' <?php echo $is_export_cost=='Y'?'selected':'';?>YES</option>
                <option value='N' <?php echo $is_export_cost=='N'?'selected':'';?>NO</option>
             </select>
        </div>
        ...
        <div class="form-group">
             <label for="varchar">Is Print After Total  <?php echo form_error('is_print_after_total') ?></label>
             <select class="form-control" name="is_print_after_total" id="is_print_after_total">
                <option value='Y' <?php echo $is_print_after_total=='Y'?'selected':'';?>YES</option>
                <option value='N' <?php echo $is_print_after_total=='N'?'selected':'';?>NO</option>
             </select>
        </div>
        ...
        <div class="form-group">
             <label for="varchar">Is Disable Change Price  <?php echo form_error('is_disable_change_price') ?></label>
             <select class="form-control" name="is_disable_change_price" id="is_disable_change_price">
                <option value='Y' <? echo $is_disable_change_price=='Y'?'selected':'';?>>YES</option>
                <option value='N' <? echo $is_disable_change_price=='N'?'selected':'';?>>NO</option>
             </select>
        </div>
        ...
        <div class="form-group">
            ...
            {
            ?>
                <option value='<?php echo $row->id?>' <?php echo $row->id== $print_kitchen_id?'selected':'';?>><?php echo $row->name?></option>
             <?php
            }
             ?>
            ...
            <div class="form-group">
            <label for="varchar">Print Kitchen Id <?php echo form_error('print_kitchen_section_id') ?></label>
	    ...
	    <a href="<?php echo base_url('referensi/inv_outlet_menus') ?>" class="btn btn-default">Cancel</a>
	</form>
