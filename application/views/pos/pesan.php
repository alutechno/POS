			...
			<div class="tab-content">
				<div class="tab-pane active" id="tab_1">
					<table class="table table-bordered text-center">
						...
						<tr>
							<td>
								<a href="<?= base_url() ?>pos/tables/inputpesan/<?= $this->session->table; ?>/1"><img
										src="<?= base_url() ?>menu/1.jpeg" width="80"
										height="80"></a></td>
							<td>
								<a href="<?= base_url() ?>pos/tables/inputpesan/<?= $this->session->table; ?>/2"><img
										src="<?= base_url() ?>menu/2.jpeg" width="80"
										height="80"></a></td>
	...
	<div class="col-md-4">
		<div class="box box-solid">
			<div class="box-header">
				<h3 class="box-title">Order Number: <?= $this->session->order_no; ?> #Table Number
					= <?= $this->session->table; ?></h3>
			</div><!-- /.box-header -->
			<div class="box-body text-center">
				...
				<iframe width="360" frameBorder="0" height="415"
						src="<?= base_url() ?>pos/tables/get_total" allowfullscreen></iframe>
