...
<div class="modal fade" id="myModalguest" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
  <div class="modal-dialog" role="document">
   ...
   <form id="subscribe-email-form" action="<?=base_url()?>main/input_guest" method="post">
                            ...
                            <!-- small box -->
                             <!--<div class="small-box <?php echo $this->global_model->get_table_available($row->id,$this->session->userdata('outlet'))==1?'bg-aqua':'bg-red'?>">
                              <div class="inner">
                                    ...
                                    <p>
                                       Table No:  <?//=$row->table_no?><br/>
                                       Capacity : <?//=$row->cover?></br>
                                ...
                                ?>
                                    ...
                                    <a   data-toggle="modal" href="#" onclick="load_guest(<?=$row->table_no?>)"> <img src="<?=base_url()?>menu/table_avai.jpeg" width="100" height="100">
                                   <?php echo $row->table_no?></a>
                                ...
                                ?>
                                    <a href="<?php echo base_url()?>main/payment/<?=$row->id?>"> <img src="<?=base_url()?>menu/table.jpeg" width="100" height="100">
                                    <?php echo $row->table_no?></a>
                                <?php
                                }
                                ?>
