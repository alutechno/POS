	    ...
	    <div class="form-group">
            ...
            <input type="text" class="form-control" name="table_no" id="table_no" placeholder="Table No" value="<?php echo $table_no; ?>" />
        </div>
	    <div class="form-group">
            <label for="varchar">Cover <?php echo form_error('cover') ?></label>
            <input type="text" class="form-control" name="cover" id="cover" placeholder="Cover" value="<?php echo $cover; ?>" />
        </div>
	    <div class="form-group">
