...
<html>
    ...
    <body>
	    ...
	    <div class="form-group">
            ...
            <input type="text" class="form-control" name="outlet_menu_id" id="outlet_menu_id" placeholder="Outlet Menu Id" value="<?php echo $outlet_menu_id; ?>" />
        </div>
	    <div class="form-group">
	    ...
	    <div class="form-group">
            ...
            <input type="text" class="form-control" name="begin_date" id="begin_date" placeholder="Begin Date" value="<?php echo $begin_date; ?>" />
        </div>
	    <div class="form-group">
	    ...
	    <div class="form-group">
            ...
            <input type="text" class="form-control" name="begin_time" id="begin_time" placeholder="Begin Time" value="<?php echo $begin_time; ?>" />
        </div>
	    <div class="form-group">
	    ...
	    <div class="form-group">
            ...
            <input type="text" class="form-control" name="discount_id" id="discount_id" placeholder="Discount Id" value="<?php echo $discount_id; ?>" />
        </div>
	    <div class="form-group">
            <label for="decimal">Discount Percent <?php echo form_error('discount_percent') ?></label>
            <input type="text" class="form-control" name="discount_percent" id="discount_percent" placeholder="Discount Percent" value="<?php echo $discount_percent; ?>" />
        </div>
	    <div class="form-group">
            <label for="decimal">Discount Amount <?php echo form_error('discount_amount') ?></label>
            <input type="text" class="form-control" name="discount_amount" id="discount_amount" placeholder="Discount Amount" value="<?php echo $discount_amount; ?>" />
        </div>
	    <div class="form-group">
            <label for="decimal">Promo Price <?php echo form_error('promo_price') ?></label>
            <input type="text" class="form-control" name="promo_price" id="promo_price" placeholder="Promo Price" value="<?php echo $promo_price; ?>" />
        </div>
	    <div class="form-group">
	    ...
	    <div class="form-group">
            <label for="varchar">Is Avail Wednesday <?php echo form_error('is_avail_wednesday') ?></label>
            <input type="text" class="form-control" name="is_avail_wednesday" id="is_avail_wednesday" placeholder="Is Avail Wednesday" value="<?php echo $is_avail_wednesday; ?>" />
        </div>
	    <div class="form-group">
