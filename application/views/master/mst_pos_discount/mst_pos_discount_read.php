...
<html>
    ...
    <body>
	    ...
	    <tr><td>Beverage</td><td><?php echo $beverage; ?></td></tr>
	    <tr><td>Others</td><td><?php echo $others; ?></td></tr>
	    ...
	    <tr><td></td><td><a href="<?php echo site_url('mst_pos_discount') ?>" class="btn btn-default">Cancel</a></td></tr>
	</table>
        </body>
</html>