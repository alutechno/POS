	    ...
	    <div class="form-group">
            ...
            <input type="text" class="form-control" name="fo_gl_journal_code" id="fo_gl_journal_code" placeholder="Fo Gl Journal Code" value="<?php echo $fo_gl_journal_code; ?>" />
        </div>
	    <div class="form-group">
            <label for="varchar">Bill Image Uri <?php echo form_error('bill_image_uri') ?></label>
            <input type="text" class="form-control" name="bill_image_uri" id="bill_image_uri" placeholder="Bill Image Uri" value="<?php echo $bill_image_uri; ?>" />
        </div>
	    <div class="form-group">
            <label for="varchar">Bill Image Path <?php echo form_error('bill_image_path') ?></label>
            <input type="text" class="form-control" name="bill_image_path" id="bill_image_path" placeholder="Bill Image Path" value="<?php echo $bill_image_path; ?>" />
        </div>
	    <div class="form-group">
            <label for="varchar">Small Bill Image Uri <?php echo form_error('small_bill_image_uri') ?></label>
            <input type="text" class="form-control" name="small_bill_image_uri" id="small_bill_image_uri" placeholder="Small Bill Image Uri" value="<?php echo $small_bill_image_uri; ?>" />
        </div>
	    <div class="form-group">
            <label for="varchar">Small Bill Image Path <?php echo form_error('small_bill_image_path') ?></label>
            <input type="text" class="form-control" name="small_bill_image_path" id="small_bill_image_path" placeholder="Small Bill Image Path" value="<?php echo $small_bill_image_path; ?>" />
        </div>
	    <div class="form-group">
            <label for="varchar">Printed Bill Image Uri <?php echo form_error('printed_bill_image_uri') ?></label>
            <input type="text" class="form-control" name="printed_bill_image_uri" id="printed_bill_image_uri" placeholder="Printed Bill Image Uri" value="<?php echo $printed_bill_image_uri; ?>" />
        </div>
	    <div class="form-group">
            <label for="varchar">Printed Bill Image Path <?php echo form_error('printed_bill_image_path') ?></label>
            <input type="text" class="form-control" name="printed_bill_image_path" id="printed_bill_image_path" placeholder="Printed Bill Image Path" value="<?php echo $printed_bill_image_path; ?>" />
        </div>
	    <div class="form-group">
            <label for="varchar">Small Printed Bill Image Uri <?php echo form_error('small_printed_bill_image_uri') ?></label>
            <input type="text" class="form-control" name="small_printed_bill_image_uri" id="small_printed_bill_image_uri" placeholder="Small Printed Bill Image Uri" value="<?php echo $small_printed_bill_image_uri; ?>" />
        </div>
	    <div class="form-group">
            <label for="varchar">Small Printed Bill Image Path <?php echo form_error('small_printed_bill_image_path') ?></label>
            <input type="text" class="form-control" name="small_printed_bill_image_path" id="small_printed_bill_image_path" placeholder="Small Printed Bill Image Path" value="<?php echo $small_printed_bill_image_path; ?>" />
        </div>
	   
	    <input type="hidden" name="id" value="<?php echo $id; ?>" /> 
	    <button type="submit" class="btn btn-primary"><?php echo $button ?></button> 
	    <a href="<?php echo site_url('mst_outlet') ?>" class="btn btn-default">Cancel</a>
	</form>
