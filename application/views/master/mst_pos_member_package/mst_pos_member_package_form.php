<form action="<?php echo $action; ?>" method="post">
	...
	<div class="form-group">
		...
		<input type="text" class="form-control" name="percent_food" id="percent_food"
			   placeholder="Percent Food" value="<?php echo $percent_food; ?>"/>
	</div>
	<div class="form-group">
		<label for="decimal">Percent Beverage <?php echo form_error('percent_beverage') ?></label>
		<input type="text" class="form-control" name="percent_beverage" id="percent_beverage"
			   placeholder="Percent Beverage" value="<?php echo $percent_beverage; ?>"/>
	</div>
	<div class="form-group">
		<label for="decimal">Percent Others <?php echo form_error('percent_others') ?></label>
		<input type="text" class="form-control" name="percent_others" id="percent_others"
			   placeholder="Percent Others" value="<?php echo $percent_others; ?>"/>
	</div>
