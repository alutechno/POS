	    ...
	    <div class="form-group">
            ...
            <input type="text" class="form-control" name="name" id="name" placeholder="Number" value="<?php echo $name; ?>" autocomplete="off" />
        </div>
         ...
         <div class="form-group">
          <label for="int">Zone  <?php echo form_error('zone_id') ?></label>
            ...
            {
            ?>
                <option value='<?php echo $row->id?>' <?php echo $row->id== $zone_id?'selected':'';?>><?php echo $row->name?>-<?php echo $row->outlet?> </option>
              <?php
              }
              ?>
            </select>
