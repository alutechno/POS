...
<html>
    ...
    <body>
	    ...
	    <div class="form-group">
            ...
            <input type="text" class="form-control" name="default_module" id="default_module" placeholder="Default Module" value="<?php echo $default_module; ?>" />
        </div>
	    <div class="form-group">
            <label for="int">Default Menu <?php echo form_error('default_menu') ?></label>
            <input type="text" class="form-control" name="default_menu" id="default_menu" placeholder="Default Menu" value="<?php echo $default_menu; ?>" />
        </div>
	    <div class="form-group">
