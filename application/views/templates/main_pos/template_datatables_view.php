...
<head>
	...
	<!-- DATA TABLES -->
	<link href="<?php echo MY_ASSETS ?>css/datatables/dataTables.bootstrap.css" rel="stylesheet"
		  type="text/css"/>
	<!-- Theme style -->
...
<!-- DATA TABES SCRIPT -->
<script src="<?php echo MY_ASSETS ?>js/plugins/datatables/jquery.dataTables.js"
		type="text/javascript"></script>
<script src="<?php echo MY_ASSETS ?>js/plugins/datatables/dataTables.bootstrap.js"
		type="text/javascript"></script>
<!-- AdminLTE App -->
