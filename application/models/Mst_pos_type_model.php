...
class Mst_pos_type_model extends CI_Model {
	...
	function json() {
		...
		$this->datatables->add_column('action', anchor(site_url('mst_pos_type/read/$1'), 'Read') . " | " . anchor(site_url('mst_pos_type/update/$1'), 'Update') . " | " . anchor(site_url('mst_pos_type/delete/$1'), 'Delete', 'onclick="javasciprt: return confirm(\'Are You Sure ?\')"'), 'id');
