...
class Inv_outlet_menus_model extends CI_Model {
	...
	function json() {
		...
		$this->datatables->add_column('action', anchor(base_url('referensi/inv_outlet_menus/update/$1'), 'Update') . " | " . anchor(base_url('referensi/inv_outlet_menus/delete/$1'), 'Delete', 'onclick="javasciprt: return confirm(\'Are You Sure ?\')"'), 'id');
