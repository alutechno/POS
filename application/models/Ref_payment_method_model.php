...
class Ref_payment_method_model extends CI_Model {
	...
	function json() {
		...
		$this->datatables->add_column('action', anchor(base_url('referensi/ref_payment_method/update/$1'), 'Update') . " | " . anchor(base_url('referensi/ref_payment_method/delete/$1'), 'Delete', 'onclick="javasciprt: return confirm(\'Are You Sure ?\')"'), 'id');
