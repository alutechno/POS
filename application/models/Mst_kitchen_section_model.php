<?php
	...
	class Mst_kitchen_section_model extends CI_Model {
		...
		function json() {
			...
			$this->datatables->add_column('action',
										  anchor(base_url('master/mst_kitchen_section/update/$1'),
												 'Update') . " | " . anchor(base_url('master/mst_kitchen_section/delete/$1'),
																			'Delete',
	...
	/* End of file Mst_kitchen_section_model.php */
	/* Location: ./application/models/Mst_kitchen_section_model.php */
