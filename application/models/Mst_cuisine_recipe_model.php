<?php
	...
	class Mst_cuisine_recipe_model extends CI_Model {
		...
		function json() {
			...
			$this->datatables->add_column('action', anchor(site_url('mst_cuisine_recipe/read/$1'),
														   'Read') . " | " . anchor(site_url('mst_cuisine_recipe/update/$1'),
																					'Update') . " | " . anchor(site_url('mst_cuisine_recipe/delete/$1'),
																											   'Delete',
